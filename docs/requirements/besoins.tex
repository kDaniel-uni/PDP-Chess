...
%Analyse de source (lecture de fichier ?...), récupération des graphes de dépendances (ou création suite à l'analyse de source ?...),  affichage des graphes.
    ...
    \begin{enumerate}
        ...
        \end{itemize}
        \item Si le mouvement est correct pour la pièce, il doit vérifier que la case ou le chemin venant vers la case n'est pas occupé par une pièce allié (hormis le cavalier qui doit juste vérifier la case d'arrivée), auquel cas, le mouvement n'est pas valide.
