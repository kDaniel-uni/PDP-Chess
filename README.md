...
```
cd existing_repo
git remote add origin https://gitlab.emi.u-bordeaux.fr/fsalomode/pdp-echec.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.emi.u-bordeaux.fr/fsalomode/pdp-echec/-/settings/integrations)
