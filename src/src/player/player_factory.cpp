    ...
    Player *pdp_chess::PlayerFactory::createPlayer(const PlayerParameters &player_parameters) {
        ...
        switch (playerType) {
            ...
            case Random:
                return createRandom();
            case AlphaBeta:
                return createMinMaxAB(player_parameters.ai_parameters);
            case NegaMax:
                return createNegaMax(player_parameters.ai_parameters);
            case NegaScout:
                return createNegaScout(player_parameters.ai_parameters);
            default:
                return createRandom();
        }
    }
